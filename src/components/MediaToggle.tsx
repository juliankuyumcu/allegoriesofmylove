    ...
    return (
        ...
        >
            <svg 
                ...
                version="1.1"
                viewBox="25 23 467.8 467.3"
                width={15} height={15}
                // style="enable-background:new 22.3 22.5 467.8 467.3;" 
                enableBackground={"new 22.3 22.5 467.8 467.3"}
                className={`${showMedia && "bg-pencil dark:bg-pencil"} transition-colors duration-300`} 
            >
                <g>
                    <path 
                        className={`${showMedia ? "stroke-ink dark:stroke-ink" : "stroke-ink dark:stroke-paper"} duration-300`} strokeWidth={15}
